                    ...
                    <div class="-mx-3 flex flex-wrap">
                        <div class="w-full px-3 sm:w-1/2">
                            <div class="mb-5">
                                ...
                                <input type="text" name="nombre" placeholder="Nombre" value="{{ $servicio->nombre }}"
                    ...
                    <div class="-mx-3 flex flex-wrap">
                        <div class="w-full px-3">
                            ...
                            <textarea name="descripcion" placeholder="Descripcion....." rows="3"
                                class="w-full rounded-md border border-[#e0e0e0] bg-white py-2 px-4 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md">{{ $servicio->descripcion }}</textarea>
                            @error('descripcion')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
