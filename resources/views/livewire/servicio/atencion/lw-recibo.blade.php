                ...
                <div class="-mx-3 flex flex-wrap">
                    <div class="w-full px-3 sm:w-1/2">
                        <div class="mb-5">
                            ...
                            <input type="text" value="{{ $atencion->cliente->nombre }}" readonly
        ...
        <div class="px-6 py-4">
            ...
            <div class="-mx-3 flex flex-wrap">
                <div class="w-full px-3 sm:w-2/6">
                    <div class="mb-5">
                        ...
                        <select class="w-full" wire:model='servicio.servicio_id'>
                            <option value="">Seleccione un servicio</option>
                            @foreach ($servicios as $servicio)
                                <option value="{{ $servicio->id }}">{{ $servicio->nombre }}</option>
                            @endforeach
                        </select>
                        @error('servicio.servicio_id')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror
                    </div>
                </div>
                ...
                <div class="w-full px-3 sm:w-1/6">
                    <div class="mb-5">
                        ...
                        <input type="text" name="" placeholder="0" wire:model.defer='servicio.precio'
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-2 px-4 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
            ...
            <table class="mb-4 min-w-full divide-y divide-gray-200">
                <thead class="rounded-3xl bg-blue-700 text-white">
                    <tr>
                        <th scope="col"
                            class="w-32 px-6 py-3 text-left text-xs font-bold uppercase tracking-wider">
                            Código
                        </th>
                    ...
                    @foreach ($lista as $producto)
                        <tr>
                            ...
                            <td class="px-6 py-2 whitespace-nowrap flex">
                                <x-jet-button
                                    wire:click="delLista({{ $producto['id'] }}, '{{ $producto['tipo'] }}' )">
                                    <x-delete />
                                </x-jet-button>
                            </td>
                        </tr>
            ...
            <div class="-mx-3 px-3 py-4 flex items-center mb-8">
                <div class="flex items-center">
                    <x-jet-button wire:click='save()' class="mr-1">
                        Guardar
                    </x-jet-button>
